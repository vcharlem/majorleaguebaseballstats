  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved team as @team" do
        ...
        post :create, {:team => { "city" => "invalid value" }}, valid_session
        assigns(:team).should be_a_new(Team)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested team" do
        ...
        Team.any_instance.should_receive(:update).with({ "city" => "MyString" })
        put :update, {:id => team.to_param, :team => { "city" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the team as @team" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Team.any_instance.stub(:save).and_return(false)
        put :update, {:id => team.to_param, :team => { "city" => "invalid value" }}, valid_session
        assigns(:team).should eq(team)
      end
