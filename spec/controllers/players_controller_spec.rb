...
describe PlayersController do
  ...
  let(:valid_attributes) { { "surname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved player as @player" do
        ...
        post :create, {:player => { "surname" => "invalid value" }}, valid_session
        assigns(:player).should be_a_new(Player)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested player" do
        ...
        Player.any_instance.should_receive(:update).with({ "surname" => "MyString" })
        put :update, {:id => player.to_param, :player => { "surname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the player as @player" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Player.any_instance.stub(:save).and_return(false)
        put :update, {:id => player.to_param, :player => { "surname" => "invalid value" }}, valid_session
        assigns(:player).should eq(player)
      end
